...
const sizes: Record<size, string> = {
  small: "text-[1.2rem] px-[0.8rem] py-[0.4rem] uppercase font-semibold text-center",
...
const variations: Record<variation, string> = {
  primary: "text-[--color-brand-50] bg-[--color-brand-600] hover:bg-[--color-brand-700]",
  secondary: "text-[--color-grey-600] bg-[--color-grey-0] border border-[--color-grey-200] hover:bg-[--color-grey-50]",
...
const Button = ({ size = "medium", variation = "primary", className = "", ...props }: ButtonProps) => {
  const baseClasses = "border-none rounded-[--border-radius-sm] shadow-[--shadow-sm]";
